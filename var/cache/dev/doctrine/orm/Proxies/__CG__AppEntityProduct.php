...
class Product extends \App\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'age', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'warranty', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'components'];
        }
     ...
     * {@inheritDoc}
     */
    public function setAge(int $age): \App\Entity\Product
    {
     ...
     * {@inheritDoc}
     */
    public function setWarranty(?int $warranty): \App\Entity\Product
    {
     ...
     * {@inheritDoc}
     */
    public function getComponents(): \Doctrine\Common\Collections\Collection
    {
     ...
     * {@inheritDoc}
     */
    public function addComponent(\App\Entity\Component $component): \App\Entity\Product
    {
     ...
     * {@inheritDoc}
     */
    public function removeProduct(\App\Entity\Component $component): \App\Entity\Product
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeProduct', [$component]);

        return parent::removeProduct($component);
    }
