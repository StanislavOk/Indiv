...
{
    /**
     * Gets the private 'App\Repository\ComponentRepository' shared autowired service.
     *
     * @return \App\Repository\ComponentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComponentRepository.php';

        return $container->privates['App\\Repository\\ComponentRepository'] = new \App\Repository\ComponentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
