...
class ComponentController extends AbstractController
{
    ...
    /**
     * @Route("/find/{name}", name="find_component_by_name")
     * @param $name
     * @param ComponentRepository $componentRepository
     * @return Response
     */
    public function findAllByName($name, ComponentRepository $componentRepository): Response
    {
        return $this->render('component/index.html.twig', [
            'components' => $componentRepository->findByName($name)
        ]);
    }
}
